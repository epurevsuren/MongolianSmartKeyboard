...
public class MNSmartKeyboard extends Keyboard {
	
	private Key mEnterKey;
	
	public MNSmartKeyboard(Context context, int xmlLayoutResId) {
		super(context, xmlLayoutResId);
	}

	public MNSmartKeyboard(Context context, int layoutTemplateResId, CharSequence characters, int columns, int horizontalPadding) {
